...
//
//   function sendPost(userUrl,submissionBody) {
//      const postConfig = {
//        Accept: "application/json",
//        method: "POST",
//        headers: {
...
//      return fetch(userUrl, postConfig)
//    }
//    //sendPost(userUrl, submissionBody);
// // }
//
// let gameSubmissionBody = {
//   "user_id": 3,
//   "score": 225
// }
//
//   function sendGame(gameUrl, gameSubmissionBody){
//     const postConfig = {
//       Accept: "application/json",
//       method: "POST",
//       headers: {
//         "Content-type": "application/json"
//       },
//       body: JSON.stringify(gameSubmissionBody)
//     };
//     return fetch(gameUrl, postConfig)
//   }
// //  sendGame(gameuserUrl, gameSubmissionBody);
